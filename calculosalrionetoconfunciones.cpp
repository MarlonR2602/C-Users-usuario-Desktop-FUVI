/*
Nombre del archivo: calculosalrionetoconfunciones.cpp
Autor: MarlonRodriguez
Lugar: ITV
...
void iniciarApp();
void calcularIngresosTotales(double salarioBasico);
void calcularDeduccionesTotales(double ingresoTotal, double salarioBasico);
void calcularIngresoNeto(double ingresoTotal, double deduccionesTotales);
void calcularINSSPatronal(double ingresoTotal);
void presentarResultados();
int main(){
	iniciarApp();
	calcularIngresosTotales(salarioBasico);
	calcularDeduccionesTotales(ingresoTotal, salarioBasico);
	calcularIngresoNeto(ingresoTotal, deduccionesTotales);
	calcularINSSPatronal(ingresoTotal);
	presentarResultados();
